  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e5e7eb] dark:border-white/10 px-6 py-4 md:px-10 lg:px-16 xl:px-40 sticky top-0 bg-background-light/95 dark:bg-background-dark/80 backdrop-blur-sm z-50">
      ...
      <div className="hidden lg:flex items-center gap-4">
        <a href="/CV/CV_DanielVinicius.pdf" download className="flex cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-6 bg-primary text-black text-sm font-bold hover:bg-opacity-90 transition-all shrink-0 shadow-[0_0_10px_rgba(57,255,20,0.3)]">
