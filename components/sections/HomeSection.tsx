            ...
            <div className="flex flex-col-reverse lg:flex-row gap-8 items-center">
              <section className="flex flex-col gap-6 flex-1 text-center lg:text-left">
                <div className="flex flex-col gap-3">
                  ...
                  <h2 className="text-sm sm:text-base lg:text-lg font-normal text-gray-300 leading-relaxed max-w-xl mx-auto lg:mx-0">
                    Sou um desenvolvedor focado em engenharia de software e venho expandindo meus 
                    conhecimentos para Arquitetura de Soluções, entendendo como sistemas e times se 
                    conectam.
                    Possuo experiência em avaliar tecnologias, documentar fluxos técnicos e colaborar 
                    com times de Operações e Marketing na melhoria e construção de projetos
                    eficientes e escaláveis. Tenho também grande interesse por cibersegurança e 
                    compliance, garantindo que essas soluções sejam robustas e seguras desde o 
                    início.
                  </h2>
                </div>
              </section>
              <figure className="w-full lg:w-[400px] flex justify-center">
                <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 xl:w-96 xl:h-96">
                  ...
                  <div className="relative w-full h-full rounded-full overflow-hidden bg-surface-dark">
                    <OptimizedImage
